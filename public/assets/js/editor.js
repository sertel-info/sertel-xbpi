	...
	var methods = {
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
						     ...
						     'ul'		: { "text": "Bullet", 
											"icon": "fa fa-list-ul", 
											"tooltip": "Inserir/Remover Pontual", 
						...
						'insert_table'	: { "modal": true,
						   ...
						   'indent'		: { "text": "Indent", 
											"icon":"fa fa-indent", 
											"tooltip": "Mais Identação", 
											"commandname":"indent", 
											"custom":null },

						   'outdent'	: { "text": "Outdent", 
											"icon":"fa fa-outdent", 
											"tooltip": "Menos Identação", 
											"commandname":"outdent", 
											"custom":null },
			...
			var statusBar = $("<div/>", {	id : "statusbar",
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").append('<div class="label">'+'Caractéres : '+charCount+'</div>');
            	});
	        }	        
