...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-edit"></i> Atualizar perfil
            </li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-8">
        {!! Form::open(array('route' => 'admin.profiles.update')) !!}

        <div class="panel-body">
            <div class="form-group">
                <label>Nome do perfil</label>
                <input class="form-control" placeholder="Digite o nome do perfil" value="Perfil 1">
            </div>
            <div class="form-group">
